...
exports.entrar = async (iduser, idsala) => {
  ...
  let usuarioModel = require('../models/usuarioModel'); // Importando o módulo 'usuarioModel' do diretório '../models'
  ...
  if (await usuarioModel.alterarUsuario(user)) { // Chamando a função 'alterarUsuario' do módulo 'usuarioModel' passando o 'user'
